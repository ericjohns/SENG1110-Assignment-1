...
public class Interface
{
    ...
    public static void main(String[] args)
    {
        ...
        showSelection(); //calling seletion
     
        do{     //error check for selection
        ...
        while(choice != 9)                                    
        {
            switch(choice)                                    
             {
             case 1: 
                    if(Movie1 == 1 & Movie2 == 1 & Movie3 == 1 & Movie4 == 1) //check if database is full
                    {
                    ...
                    else 
                    {
                        ...
                        {
                            System.out.println("Enter movie name");//call fall variables
                            Mname = console.next();
                            ...
                            MnameCheck1 = md.M1getName(); //chack variablesto lower case
                            ...
                            if((Objects.equals(Mname, MnameCheck1))|(Objects.equals(Mname, MnameCheck2))|(Objects.equals(Mname, MnameCheck3))|(Objects.equals(Mname, MnameCheck4))) //check for duplicate
                            {
                        ...
                        else if (Movie1 == 1 & Movie2 == 0 & Movie3 == 0 & Movie4 == 0)
                        {
                            ...
                            {
                                md.addData(2, Mname, Dname , FSname, DURname); //save movie
                                Movie2 = 1;
                            }    
                        }
             ...
             case 2:
                    ...
                    if(delete == 1) //delete movie and remove from playlist if neccessary
                    {
                        Movie1 = 0;
             ...
             case 3:
                    System.out.println("Movie Database"); //print movie database
                    if(Movie1 == 1)
                    {
             ...
             case 4:
                    if(playlist1 == 1 & playlist2 == 1) //create playlist
                    {
                        System.out.println("Database is Full");
                    }
                    else
                    ...
                    if(Movie1 == 1)
                    {
                    System.out.println("Movie 1:"+md.M1getName()); //print database
                    }
                    if(Movie2 == 1)
                    {
                    System.out.println("Movie 2:"+md.M2getName());
                    ...
                    {
                    System.out.println("Enter 1st movie"); //enters first movie into database
                    do{
                        if(console.hasNextInt())
                        {
             ...
             case 5:
                    {
                        if(playlist1 == 1) //Print playlists
                        {
             ...
             case 6:
             {
                    ...
                    if(playlist1==1) //deletes a playlist
                    {
                        System.out.println("Playlist 1:");
                        getPlaylistMovie = P1.getMovie1();
                        if(getPlaylistMovie == 1)
             ...
             case 7:
             {
                 System.out.println("To delete a Movie enter the number associated with the playlist it is in");
                    ...
                    if(playlist1==1) //deletes a movie assoicated tothe playlist
                    {
                        System.out.println("Playlist 1:");
                        getPlaylistMovie = P1.getMovie1();
                        if(getPlaylistMovie == 1)
             ...
             case 8:
             { 
                            System.out.println("List of movies with same director"); //lists movies associated to the same director
                            DnameCheck1 = md.M1getDirector();
                            DnameCheck2 = md.M2getDirector();
                            DnameCheck3 = md.M3getDirector();
                            DnameCheck4 = md.M4getDirector();
                            ...
                            DnameCheck3= DnameCheck3.toLowerCase();
                            DnameCheck4= DnameCheck4.toLowerCase();
                            if(Objects.equals(DnameCheck1, DnameCheck2)) //checks directors between movies
                            {
